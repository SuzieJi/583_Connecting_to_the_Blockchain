...
api_url = "https://ethereum-mainnet.core.chainstack.com/1738c4eaab13acca29645e821bd28e5b"  # YOU WILL NEED TO PROVIDE THE URL OF AN ETHEREUM NODE
...
def get_ape_info(ape_id):
    ...
    if token_uri.startswith("ipfs://"):
        path = token_uri.split("ipfs://", 1)[1]
        url = f"https://ipfs.io/ipfs/{path}"
    else:
        url = token_uri
